...
- [x] Fase 5 complete (Buyer flow)
- [x] Ada data `impact_metrics` di PocketBase (auto-calculated via hooks)
- [x] FCM/APNS credentials untuk push notification
- [x] `bun add recharts`
...
- [x] **P6-T1** Buat hooks untuk Enabler:
...
- [x] **P6-T2** Halaman Dashboard Enabler: `src/app/(enabler)/dashboard/page.tsx`
...
- [x] **P6-T3** Halaman Manajemen User: `src/app/(enabler)/users/page.tsx`
...
- [x] **P6-T8** Buat Zustand wallet store: `src/lib/stores/wallet-store.ts`
  - `balance: number`
  - `updateBalance(amount)`
  - Sync dengan PocketBase
- [x] **P6-T9** Halaman Dompet Digital: `src/app/(shared)/wallet/page.tsx`
...
- [x] **P6-T10** Buat komponen `WalletBalanceCard`:
...
- [x] **P6-T12** Halaman Chat: `src/app/(shared)/chat/page.tsx`
  - Split layout:
...
- [x] **P6-T13** Buat komponen `ChatBubble`:
...
- [x] **P6-T14** Setup realtime subscription chat:
...
- [x] **P6-T15** Buat hooks notifikasi:
...
- [x] **P6-T16** Halaman Notifikasi: `src/app/(shared)/notifications/page.tsx`
...
- [x] **P6-T17** Buat komponen `NotificationBadge`:
  ...
  - Unread count
  - Real-time update
- [x] **P6-T18** Setup Push Notification (Capacitor):
  - Register FCM token
...
- [x] **P6-T19** Halaman Profil: `src/app/(shared)/profile/page.tsx`
  ...
  - Change password
  - Logout button
- [x] **P6-T20** Buat komponen `MapPicker`:
  - `src/components/features/map-picker.tsx`
  - Leaflet map + draggable marker
  - Search location by name
  - Return lat/lng
- [x] **P6-T21** Loading states: Skeleton wallet, skeleton chat list
- [x] **P6-T22** Empty: "Belum ada transaksi" / "Belum ada chat" / "Belum ada notifikasi"
- [x] **P6-T23** i18n: semua string Enabler + Shared features
- [x] **P6-T24** Responsive: Chat split layout di desktop, single column di mobile
...
- [x] **T-P6-6** `useWalletBalance` return number
- [x] **T-P6-7** `useWalletTransactions` return list
- [x] **T-P6-8** `useWalletTransactions` filter by type

### Hooks — useChat

- [x] **T-P6-9** `useConversations` return grouped list
- [x] **T-P6-10** `useConversations` sorted by latest message
- [x] **T-P6-11** `useMessages` return array
- [x] **T-P6-12** `useMessages` realtime update
- [x] **T-P6-13** `useSendMessage` mutation sukses
- [x] **T-P6-14** `useMarkAsRead` update status

### Store — WalletStore

- [x] **T-P6-15** Initial balance 0
- [x] **T-P6-16** `updateBalance` adds/subtracts
- [x] **T-P6-17** Persist balance

### Halaman — Enabler Dashboard

- [x] **T-P6-18** 4 impact cards render
- [x] **T-P6-19** Bar chart render
- [x] **T-P6-20** Period filter works
- [x] **T-P6-21** Export CSV

### Halaman — User Management

- [x] **T-P6-22** DataTable render users
- [x] **T-P6-23** Filter by role
- [x] **T-P6-24** Search by name/email
- [x] **T-P6-25** Bulk verification

### Halaman — Wallet

- [x] **T-P6-26** Balance card render
- [x] **T-P6-27** Transaction list render
- [x] **T-P6-28** Top-up flow

### Halaman — Chat

- [x] **T-P6-29** Conversation list render
- [x] **T-P6-30** Click conversation → load messages
- [x] **T-P6-31** Send message → appear in chat
- [x] **T-P6-32** Real-time: new message appears
- [x] **T-P6-33** Unread badge update
- [x] **T-P6-34** Mobile: toggle list/chat

### Halaman — Notifications

- [x] **T-P6-35** List notifications
- [x] **T-P6-36** Mark as read
- [x] **T-P6-37** Mark all as read
- [x] **T-P6-38** Click → redirect

### Halaman — Profile

- [x] **T-P6-39** Edit profile form
- [x] **T-P6-40** Upload avatar
- [x] **T-P6-41** Change password
- [x] **T-P6-42** Upload dokumen

---

## 6. Acceptance Criteria

- [x] **AC-1** Enabler dashboard menampilkan 4 metrik impact + chart
- [x] **AC-2** Filter period (1 bln, 3 bln, 1 thn) mengubah data chart
- [x] **AC-3** Enabler bisa export data impact ke CSV
- [x] **AC-4** Enabler bisa melihat & verifikasi user
- [x] **AC-5** Dokumen legalitas bisa di-approve/reject
- [x] **AC-6** Wallet balance tampil di semua halaman (navbar)
- [x] **AC-7** Riwayat transaksi wallet bisa difilter
- [x] **AC-8** Chat realtime — pesan baru muncul tanpa refresh
- [x] **AC-9** Unread badge notifikasi realtime
- [x] **AC-10** Push notification (Capacitor) berfungsi
- [x] **AC-11** Profil bisa diedit, avatar diupload
- [x] **AC-12** Map picker untuk lokasi
- [x] **AC-13** Semua halaman responsive
- [x] **AC-14** `bun test` lulus minimal 80%
