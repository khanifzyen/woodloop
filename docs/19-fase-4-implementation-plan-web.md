...
- [ ] Fase 3 complete (Aggregator flow)
- [ ] Ada data warehouse_inventory dari Aggregator (bahan limbah siap jual)
- [ ] Ada data design_recipes di PocketBase (untuk Design Clinic)
...
- [ ] **P4-T1** Buat TanStack Query hooks untuk Converter:
...
- [ ] **P4-T2** Halaman Dashboard Converter: `src/app/(converter)/dashboard/page.tsx`
  - 4 summary cards:
    - Bahan Dibeli (🛒)
    - Produk Dibuat (🎨)
    - Total Investasi (💰)
...
- [ ] **P4-T3** Halaman Pasar Bahan: `src/app/(converter)/marketplace/materials/page.tsx`
...
- [ ] **P4-T4** Buat komponen `MaterialCard`:
...
- [ ] **P4-T5** Halaman Detail Bahan: `src/app/(converter)/marketplace/materials/[id]/page.tsx`
...
- [ ] **P4-T6** Halaman Checkout: `src/app/(converter)/checkout/page.tsx`
...
- [ ] **P4-T9** Halaman Katalog Produk Saya: `src/app/(converter)/catalog/page.tsx`
...
- [ ] **P4-T10** Halaman Buat Produk: `src/app/(converter)/catalog/new/page.tsx`
  - Form:
    - Name: Input
...
- [ ] **P4-T11** Halaman Edit Produk: `src/app/(converter)/catalog/[id]/edit/page.tsx`
  - Pre-filled form
  - Update stock, price, photos
- [ ] **P4-T12** Buat komponen `QRCodeDisplay`:
...
- [ ] **P4-T13** Halaman Klinik Desain: `src/app/(converter)/design-clinic/page.tsx`
  - Grid: `design_recipes`
  - Card: foto hasil, judul, difficulty badge, wood types
  - Filter: difficulty (easy, medium, hard), wood type, form
  - Search by title / description
- [ ] **P4-T14** Halaman Detail Resep: `src/app/(converter)/design-clinic/[id]/page.tsx`
  - Galeri foto
...
- [ ] **P4-T15** Buat komponen `DesignRecipeCard`:
...
- [ ] **P4-T16** Loading: Skeleton grid untuk marketplace & catalog
- [ ] **P4-T17** Empty: "Belum ada bahan" / "Belum ada produk"
- [ ] **P4-T18** Error: Alert + retry untuk failed query
- [ ] **P4-T19** i18n: semua string Converter
- [ ] **P4-T20** Responsive: grid 2 kolom mobile, 4 kolom desktop
- [ ] **P4-T21** E2E: Converter browse → beli bahan → buat produk → generate QR
...
- [ ] **T-P4-1** `useConverterDashboard` return correct shape
- [ ] **T-P4-2** `useMarketplaceMaterials` filter by wood_type
- [ ] **T-P4-3** `useMarketplaceMaterials` filter by price range
- [ ] **T-P4-4** `useMarketplaceMaterials` sort by price
- [ ] **T-P4-5** `useCreateMarketplaceTransaction` mutation sukses
- [ ] **T-P4-6** `useConverterProducts` return array
- [ ] **T-P4-7** `useCreateProduct` dengan source_transactions
- [ ] **T-P4-8** `useDesignRecipes` filter by difficulty

### Components — MaterialCard

- [ ] **T-P4-9** Render foto + info
- [ ] **T-P4-10** Badge wood type + form
- [ ] **T-P4-11** Price formatting
- [ ] **T-P4-12** Click → navigate ke detail
- [ ] **T-P4-13** Stock indicator (Progress)

### Components — QRCodeDisplay

- [ ] **T-P4-14** Generate QR dari qr_code_id
- [ ] **T-P4-15** URL format benar
- [ ] **T-P4-16** Download QR as PNG
- [ ] **T-P4-17** Share button (native)

### Halaman — Marketplace Materials

- [ ] **T-P4-18** Grid render cards
- [ ] **T-P4-19** Filter panel works
- [ ] **T-P4-20** Search by wood type
- [ ] **T-P4-21** Sort by price
- [ ] **T-P4-22** Pagination
- [ ] **T-P4-23** Empty state

### Halaman — Checkout

- [ ] **T-P4-24** List items + total price
- [ ] **T-P4-25** Payment method selection
- [ ] **T-P4-26** Submit creates transaction
- [ ] **T-P4-27** Error handling (saldo tidak cukup)

### Halaman — Catalog / Create Product

- [ ] **T-P4-28** Form validation
- [ ] **T-P4-29** Source materials select
- [ ] **T-P4-30** Auto-generate QR code ID
- [ ] **T-P4-31** Submit creates product + QR

### Halaman — Design Clinic

- [ ] **T-P4-32** Grid render recipes
- [ ] **T-P4-33** Filter by difficulty
- [ ] **T-P4-34** Search by title
- [ ] **T-P4-35** Click → detail page

---

## 6. Acceptance Criteria

- [ ] **AC-1** Converter bisa login & lihat dashboard dengan data real
- [ ] **AC-2** Marketplace bahan limbah menampilkan inventory dari Aggregator
- [ ] **AC-3** Filter & search marketplace berfungsi penuh
- [ ] **AC-4** Converter bisa beli bahan limbah (checkout flow)
- [ ] **AC-5** Transaksi tercatat di `marketplace_transactions`
- [ ] **AC-6** Converter bisa CRUD produk upcycled
- [ ] **AC-7** Setiap produk punya QR code yang bisa didownload
- [ ] **AC-8** Source materials terhubung ke transaksi untuk traceability
- [ ] **AC-9** Design Clinic menampilkan resep desain
- [ ] **AC-10** Filter & search design clinic
- [ ] **AC-11** Semua halaman responsive (mobile-first)
