  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="heading-2">Profil Aggregator</h1>
          <p className="text-muted-foreground mt-1">
            Kelola data usaha dan dokumen perizinan
          </p>
        </div>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">Informasi Usaha</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="workshop">Nama Perusahaan</Label>
          ...
          <div className="flex justify-end gap-3">
            <Button variant="outline" asChild><Link href="/aggregator/dashboard">Batal</Link></Button>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="border-t pt-4 space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="doc_name" placeholder="Contoh: Izin Usaha 2026" value={newDocName} onChange={(e) => setNewDocName(e.target.value)} />
                </div>
                <div className="space-y-2">
